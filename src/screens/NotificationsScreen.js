  ...
  const notifications = [
    {
      ...
      message: 'Serenity AI has generated new insights based on your latest environmental data. Check the dashboard for updates.',
      timestamp: '2024-11-30 12:00 PM',
    },
    {
      id: 2,
      title: 'System Update Completed!',
      message: 'The latest system update for Serenity AI has been successfully applied. Enjoy the improved performance and new features.',
      timestamp: '2024-11-29 10:30 AM',
    },
    {
      id: 3,
      title: 'New EHS Audit Template Added!',
      message: 'A new audit template for health and safety compliance has been added to Serenity AI. Start your audit today.',
      timestamp: '2024-11-28 08:00 AM',
    },
    {
      id: 4,
      title: 'AI Recommendations Available!',
      message: 'Serenity AI has generated new recommendations to improve safety protocols based on recent incident reports.',
      timestamp: '2024-11-27 05:30 PM',
    },
    {
      id: 5,
      title: 'Automated Workflow Triggered!',
      message: 'Serenity AI has automatically triggered a new workflow based on real-time data. Check your dashboard for details.',
